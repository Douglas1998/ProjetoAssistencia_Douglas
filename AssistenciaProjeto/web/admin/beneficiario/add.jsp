            ...
            <form action="add-ok.jsp" method="post">
                ...
                <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
                    ...
                    <div class="mdl-tabs__panel is-active" id="dados-pessoais">
                        ...
                        <div class="mdl-cell--12-col"> 
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" name="txtCpf" required  id="txtCpf" />
                    ...
                    <div class="mdl-tabs__panel" id="dados-pagamento">                              
                        ...
                        <div class="mdl-cell--12-col"> 
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" name="txtAgencia" required  id="txtAgencia" />
                        ...
                        <div class="mdl-cell--12-col"> 
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" name="txtConta" required  id="txtConta" />
                    ...
                    <div class="mdl-tabs__panel" id="dados-socioeconomicos">                                 
                        ...
                        <div class="mdl-cell--12-col"> 
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" name="txtrendaPercapita" required  id="txtrendaPercapita" />
